...
{
    { 1, 425 },  // Plater od Firlika WL
    { 2, 463 },  // Plater od Firlika PW
    { 3, 510 },  // Sczanieckiej L
    { 4, 600 },  // Sczanieckiej W
    { 5, 555 },  // Sczanieckiej PW
    { 6, 425 },  // Plater od Staszica L
    { 7, 463 },  // Plater od Staszica PW
    { 8, 570 },  // Gontyny WL
    { 9, 570 }   // Gontyny PW
};
